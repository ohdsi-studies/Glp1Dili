...
cdmDatabaseSchema <- "main" # The database / schema where the data in CDM format live
workDatabaseSchema <- "main" # A database /schema where study tables can be written
cohortTableName <- "eunomia_test_cohorts" # Where the cohorts will be written
outputLocation <- file.path(tempdir(), "eunomiaTest") # Where the intermediate and output files will be written
