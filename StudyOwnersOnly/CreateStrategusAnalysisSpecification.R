...
# CohortMethod v6 returns R6 objects that ParallelLogger cannot serialize.
# Round-trip through temp files using CohortMethod's own save functions to get plain lists.
